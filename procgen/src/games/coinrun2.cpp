...
std::vector<const char *> WALKING_ENEMIES2 = {"slimeBlue", "slimeGreen"};
std::vector<const char *> PLAYER_THEME_COLORS2 = {"Blue"};
std::vector<const char *> GROUND_THEMES2 = {"Grass"};

const int NUM_GROUND_THEMES = (int)(GROUND_THEMES2.size());

class CoinRun2 : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        main_bg_images_ptr = &platform_backgrounds_battle1;
    }
...
REGISTER_GAME("coinrun2", CoinRun2);
