...
const int NUM_ATTACK_MODES = 1;

const int NUM_LASER_THEMES = 1;
...
class BossfightGame5 : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        main_bg_images_ptr = &space_background5;
    }

    void asset_for_type(int type, std::vector<QString> &names) override {
        if (type == PLAYER) {
            names.push_back(QString("misc_assets/playerShip3_blue.png"));
        } else if (type == BOSS) {
            names.push_back(QString("misc_assets/enemyShipBlack5.png"));
        } else if (type == ENEMY_BULLET) {
            names.push_back(QString("misc_assets/laserRed11.png"));
        } else if (type == PLAYER_BULLET) {
            names.push_back(QString("misc_assets/laserBlue02.png"));
...
REGISTER_GAME("bossfight5", BossfightGame5);
