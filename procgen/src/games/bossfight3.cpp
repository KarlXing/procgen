...
class BossfightGame3 : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        main_bg_images_ptr = &space_background3;
    }

    void asset_for_type(int type, std::vector<QString> &names) override {
        if (type == PLAYER) {
            names.push_back(QString("misc_assets/playerShip3_green.png"));
        } else if (type == BOSS) {;
...
REGISTER_GAME("bossfight3", BossfightGame3);
