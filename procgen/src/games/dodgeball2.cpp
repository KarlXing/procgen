...
const int NUM_ENEMY_THEMES = 1;

const float ENEMY_VEL = 0.05f;
const float BALL_V_ROT = PI * 0.23f;

class DodgeballGame2 : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        main_bg_images_ptr = &topdown_background2;
    }
...
REGISTER_GAME("dodgeball2", DodgeballGame2);
