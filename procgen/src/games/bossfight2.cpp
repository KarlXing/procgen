...
class BossfightGame2 : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        main_bg_images_ptr = &space_background2;
    }

    void asset_for_type(int type, std::vector<QString> &names) override {
        if (type == PLAYER) {
            names.push_back(QString("misc_assets/playerShip2_red.png"));
        } else if (type == BOSS) {
...
REGISTER_GAME("bossfight2", BossfightGame2);
